...
#@onready var _camTarget:Node3D=get_node(_camTarget_path) as Node3D
var _camTarget:Node3D
@export var _camTarget_path:NodePath 
...
func _ready() -> void:
	_camTarget=get_node(_camTarget_path) as Node3D
