...
func _handle_physics(delta) -> void:
	...
	currentDrivePower =  0.1#torqueCurve.interpolate_baked(speedInterp) * drivePerRay
...
func _physics_process(delta) -> void:
	...
	var vector3:Vector3=(linear_velocity) * global_transform.basis.z
	currentSpeed = vector3.z
